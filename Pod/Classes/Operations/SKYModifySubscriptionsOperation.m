...
- (void)prepareForRequest
{
    ...
    self.request = [[SKYRequest alloc] initWithAction:@"subscription:save"
                                             payload:payload];
...
//        NSError *error = nil;
        ...
        if (subscriptionID) {
            ...
            if ([subscriptionType isEqual:SKYSubscriptionSerializationSubscriptionTypeQuery]) {
                // do nothing
            } else if ([subscriptionType isEqual:SKYSubscriptionSerializationSubscriptionTypeError]) {
//                NSMutableDictionary *userInfo = [SKYDataSerialization userInfoWithErrorDictionary:dict];
