 ...
 */
@property (nonatomic, copy) NSDictionary<NSString *, id> *_Nullable authData;
 ...
 */
@property (nonatomic, copy) NSDictionary<NSString *, id> *_Nullable profile;
 ...
 */
+ (instancetype)operationWithAuthData:(NSDictionary<NSString *, id> *)authData
                             password:(NSString *)password
                              profile:(NSDictionary<NSString *, id> *_Nullable)profile;
