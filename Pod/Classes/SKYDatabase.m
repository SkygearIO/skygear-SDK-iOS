...
- (void)saveSubscription:(SKYSubscription *)subscription
       completionHandler:(void (^)(SKYSubscription *subscription,
                                   NSError *error))completionHandler {
    SKYModifySubscriptionsOperation *operation = [[SKYModifySubscriptionsOperation alloc] initWithSubscriptionsToSave:@[subscription]];
...
- (void)od_prepareRecordForSaving:(SKYRecord *)record
{
    if (![record isKindOfClass:[SKYRecord class]]) {
        NSString *reason = [NSString stringWithFormat:@"The given object %@ is not an SKYRecord.", record];
...
- (void)saveRecord:(SKYRecord *)record completion:(SKYRecordSaveCompletion)completion {
    ...
    SKYModifyRecordsOperation *operation = [[SKYModifyRecordsOperation alloc] initWithRecordsToSave:@[record]];
...
- (void)saveRecords:(NSArray *)records completionHandler:(void (^)(NSArray *, NSError *))completionHandler perRecordErrorHandler:(void (^)(SKYRecord *, NSError *))errorHandler
{
    [records enumerateObjectsUsingBlock:^(SKYRecord *obj, NSUInteger idx, BOOL *stop) {
        [self od_prepareRecordForSaving:obj];
    }];
    
    SKYModifyRecordsOperation *operation = [[SKYModifyRecordsOperation alloc] initWithRecordsToSave:records];
...
- (void)fetchRecordWithID:(SKYRecordID *)recordID
        completionHandler:(void (^)(SKYRecord *record,
                                    NSError *error))completionHandler {
    SKYFetchRecordsOperation *operation = [[SKYFetchRecordsOperation alloc] initWithRecordIDs:@[recordID]];
...
- (void)fetchRecordsWithIDs:(NSArray *)recordIDs completionHandler:(void (^)(NSDictionary *, NSError *))completionHandler perRecordErrorHandler:(void (^)(SKYRecordID *, NSError *))errorHandler
{
    SKYFetchRecordsOperation *operation = [[SKYFetchRecordsOperation alloc] initWithRecordIDs:recordIDs];
...
- (void)deleteRecordWithID:(SKYRecordID *)recordID
         completionHandler:(void (^)(SKYRecordID *recordID,
                                     NSError *error))completionHandler
{
    SKYDeleteRecordsOperation *operation = [[SKYDeleteRecordsOperation alloc] initWithRecordIDsToDelete:@[recordID]];
...
- (void)deleteRecordsWithIDs:(NSArray *)recordIDs completionHandler:(void (^)(NSArray *, NSError *))completionHandler perRecordErrorHandler:(void (^)(SKYRecordID *, NSError *))errorHandler
{
    SKYDeleteRecordsOperation *operation = [[SKYDeleteRecordsOperation alloc] initWithRecordIDsToDelete:recordIDs];
...
- (void)performQuery:(SKYQuery *)query completionHandler:(void (^)(NSArray *, NSError *))completionHandler
{
...
- (void)performCachedQuery:(SKYQuery *)query completionHandler:(void (^)(NSArray *, BOOL, NSError *))completionHandler
{
