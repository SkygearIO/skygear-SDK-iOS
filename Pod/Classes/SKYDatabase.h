...
/**
 ...
 Use this method to fetch a single record from Ourd by specifying a <SKYRecordID>. The fetch will be performed asynchronously
 and <completeionHandler> will be called when the operation completes.
 
 This is a convenient method for <SKYFetchRecordsOperation>, which supports fetching multiple records by specifying multiple <SKYRecordID>s.
...
/**
 ...
 Use this method to fetch multiple records from Ourd by specifying an array of <SKYRecordID>s. The fetch will be performed asynchronously
 and <completeionHandler> will be called when the operation completes.
...
/**
 ...
 Use this method to save a single record to Ourd by specifying a <SKYReord>. The save will be performed asynchronously and
 ...
 This is a convenient method for <SKYModifyRecordsOperation>, which supports saving multiple records by specifying multiple <SKYRecordID>s.
...
/**
 ...
 Use this method to save multiple record to Ourd by specifying an array of <SKYReord>s. The save will be performed asynchronously and
 <completionHandler> will be called when the operation completes.
...
/**
 ...
 Use this method to delete a single record from Ourd by specifying a <SKYRecordID>. The deletion will be performed asynchronously and
 <completionHandler> will be called when the operation completes.
 
 This is a convenient method for <SKYDeleteRecordsOperation>, which supports deleting multiple records by specifying multiple <SKYRecordID>s.
...
/**
 ...
 Use this method to delete multiple records from Ourd by specifying a <SKYRecordID>s. The deletion will be performed asynchronously and
 <completionHandler> will be called when the operation completes.
...
- (void)fetchUserNewsFeed:(NSString *)newsfeedID completionHandler:(void (^)(SKYRecord *results, NSError *error))completionHandler;
