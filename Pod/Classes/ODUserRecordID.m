...
- (id)copyWithZone:(NSZone *)zone {
    ODUserRecordID *recordID = [[self.class allocWithZone:zone] initWithUsername:self.username email:_email authData:_authData];
    return recordID;
}
...
- (BOOL)isEqual:(id)object
{
    ...
    if (![object isKindOfClass:[ODUserRecordID class]]) {
        return NO;
    }
