...
/**
 <ODResultArrayResponse> implements a common processing pattern for processing response dictionary.
 ...
 */
@interface ODResultArrayResponse : ODResponse
