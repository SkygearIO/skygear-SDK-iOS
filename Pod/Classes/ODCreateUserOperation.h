...
/**
 <ODCreateUserOperation> is a subclass of <ODOperation> which an user object
 in Ourd. Use this operation to create a new user account in the container.
 When a new user is created, an <ODUserRecordID> and an <ODAccessToken>
 will be returned.
 ...
 */
@interface ODCreateUserOperation : ODOperation
...
/**
 ...
 - *recordID*: An <ODUserRecordID> object containing the user record identifier.
 - *accessToken*: An <ODAccessToken> object for performing other operations on behalf of this user.
 - *error*: If an error occurred, this object describes the error.
 */
@property (nonatomic, copy) void (^createCompletionBlock)(ODUserRecordID *recordID, ODAccessToken *accessToken, NSError *error);
