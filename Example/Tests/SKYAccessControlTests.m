...
describe(@"Access Control Entry", ^{
    it(@"serializes correctly", ^{
        SKYAccessControlEntry *readRelationEntry = [SKYAccessControlEntry readEntryForRelation:[SKYRelation relationFriend]];
        SKYAccessControlEntry *writeRelationEntry = [SKYAccessControlEntry writeEntryForRelation:[SKYRelation relationFollow]];
        SKYAccessControlEntry *readUserIDEntry = [SKYAccessControlEntry readEntryForUserID:[SKYUserRecordID recordIDWithUsername:@"userid0"]];
        SKYAccessControlEntry *writeUserIDEntry = [SKYAccessControlEntry writeEntryForUserID:[SKYUserRecordID recordIDWithUsername:@"userid1"]];
