...
describe(@"fetch subscription", ^{
    ...
    it(@"single subscription", ^{
        SKYFetchSubscriptionsOperation *operation = [SKYFetchSubscriptionsOperation operationWithSubscriptionIDs:@[@"sub1"]];
    ...
    it(@"multiple subscriptions", ^{
        SKYFetchSubscriptionsOperation *operation = [SKYFetchSubscriptionsOperation operationWithSubscriptionIDs:@[@"sub1", @"sub2"]];
        operation.deviceID = @"DEVICE_ID";
        operation.container = container;
        operation.database = database;
