...
describe(@"send push", ^{
    ...
    it(@"send to device", ^{
        SKYSendPushNotificationOperation *operation = [SKYSendPushNotificationOperation operationWithNotificationInfo:notificationInfo deviceIDsToSend:@[ @"johndoe" ]];
    ...
    it(@"send to user", ^{
        SKYSendPushNotificationOperation *operation = [SKYSendPushNotificationOperation operationWithNotificationInfo:notificationInfo userIDsToSend:@[ @"johndoe" ]];
        operation.container = container;
        [operation prepareForRequest];
    ...
    it(@"send multiple", ^{
        SKYSendPushNotificationOperation *operation = [SKYSendPushNotificationOperation operationWithNotificationInfo:notificationInfo userIDsToSend:@[ @"johndoe", @"janedoe" ]];
        operation.container = container;
        [operation prepareForRequest];
