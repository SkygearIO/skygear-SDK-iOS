...
describe(@"create", ^{
    ...
    it(@"normal user request", ^{
        SKYCreateUserOperation *operation = [SKYCreateUserOperation operationWithEmail:@"user@example.com" password:@"password"];
    ...
    it(@"anonymous user request", ^{
        SKYCreateUserOperation *operation = [SKYCreateUserOperation operationWithAnonymousUserAndPassword:@"password"];
        operation.container = container;
        [operation prepareForRequest];
        SKYRequest *request = operation.request;
        expect([request class]).to.beSubclassOf([SKYRequest class]);
