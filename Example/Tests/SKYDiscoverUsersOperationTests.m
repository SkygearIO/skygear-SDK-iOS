...
describe(@"discover", ^{
    ...
    beforeEach(^{
        ...
        [container updateWithUserRecordID:[SKYUserRecordID recordIDWithUsername:@"USER_ID"] accessToken:[[SKYAccessToken alloc] initWithTokenString:@"ACCESS_TOKEN"]];
    });
    ...
    it(@"make request", ^{
        SKYQueryUsersOperation *operation = [[SKYQueryUsersOperation alloc] initWithEmails:@[@"john.doe@example.com", @"jane.doe@example.com"]];
